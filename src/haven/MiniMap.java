...
public class MiniMap extends Widget {
    ...
    private void updateMineSupportOverlays() {
        try {
            if (OptWnd.showGroundSupportOverlayCheckBox == null || !OptWnd.showGroundSupportOverlayCheckBox.a) {
                return;
            }
            GameUI gui = getparent(GameUI.class);
    ...
    private void setupMineSupportCallback() {
        ...
        mineSupportCallback = new OCache.ChangeCallback() {
            ...
            public void added(Gob gob) {
                if (OptWnd.showGroundSupportOverlayCheckBox != null && OptWnd.showGroundSupportOverlayCheckBox.a && isMineSupport(gob)) {
            ...
            public void removed(Gob gob) {
                if (OptWnd.showGroundSupportOverlayCheckBox != null && OptWnd.showGroundSupportOverlayCheckBox.a && mineSupportGobIds.remove(gob.id)) {
                    requestMineSupportUpdate();
                }
            }
        };
